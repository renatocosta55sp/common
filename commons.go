...
import (
	...
	"github.com/renatocosta55sp/common/enums"
...
func RandomStringAndNumber(length int) string {
	charset := enums.XYZ_COMMONS_RANDOM_STRING_CHARSET
...
func ValidateEmail(email string) bool {
	...
	result, _ := regexp.MatchString(enums.XYZ_COMMONS_REGEX_EMAIL_MATCH_STRING, email)
	return result
}
...
func GetContentTypeOf(fileName string) string {
	...
	switch extension {
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_PNG:
		return enums.XYZ_COMMONS_CONTENT_TYPE_PNG
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_JPG:
		return enums.XYZ_COMMONS_CONTENT_TYPE_JPG
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_JPEG:
		return enums.XYZ_COMMONS_CONTENT_TYPE_JPEG
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_GIF:
		return enums.XYZ_COMMONS_CONTENT_TYPE_GIF
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_TIF:
		return enums.XYZ_COMMONS_CONTENT_TYPE_TIF
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_TIFF:
		return enums.XYZ_COMMONS_CONTENT_TYPE_TIFF
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_CSS:
		return enums.XYZ_COMMONS_CONTENT_TYPE_CSS
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_JS:
		return enums.XYZ_COMMONS_CONTENT_TYPE_JS
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_JSON:
		return enums.XYZ_COMMONS_CONTENT_TYPE_JSON
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_PDF:
		return enums.XYZ_COMMONS_CONTENT_TYPE_PDF
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_PPT:
		return enums.XYZ_COMMONS_CONTENT_TYPE_PPT
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_DOC:
		return enums.XYZ_COMMONS_CONTENT_TYPE_DOC
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_XLS:
		return enums.XYZ_COMMONS_CONTENT_TYPE_XLS
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_XLSX:
		return enums.XYZ_COMMONS_CONTENT_TYPE_XLSX
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_XML:
		return enums.XYZ_COMMONS_CONTENT_TYPE_XML
	case enums.XYZ_COMMONS_CONTENT_TYPE_SUFFIX_SVG:
		return enums.XYZ_COMMONS_CONTENT_TYPE_SVG
	}
...
func MaskEmail(email string) (string, error) {
	if !ValidateEmail(email) {
		return "", errors.New(enums.XYZ_COMMONS_MASK_EMAIL_ERROR_MESSAGE)
	}
...
func GetCountryAcronymFromAreaCode(phoneAreaCode int) string {
	codes := map[int]string{
		1:   enums.XYZ_COMMONS_COUNTRY_AREA_CODE_US,
		33:  enums.XYZ_COMMONS_COUNTRY_AREA_CODE_FR,
		34:  enums.XYZ_COMMONS_COUNTRY_AREA_CODE_ES,
		39:  enums.XYZ_COMMONS_COUNTRY_AREA_CODE_IT,
		44:  enums.XYZ_COMMONS_COUNTRY_AREA_CODE_GB,
		49:  enums.XYZ_COMMONS_COUNTRY_AREA_CODE_DE,
		54:  enums.XYZ_COMMONS_COUNTRY_AREA_CODE_AR,
		55:  enums.XYZ_COMMONS_COUNTRY_AREA_CODE_BR,
		81:  enums.XYZ_COMMONS_COUNTRY_AREA_CODE_JP,
		86:  enums.XYZ_COMMONS_COUNTRY_AREA_CODE_CN,
		351: enums.XYZ_COMMONS_COUNTRY_AREA_CODE_PT,
	}
...
func AddTimezoneInTime(date time.Time, timezone string) (newDate time.Time, err error) {
	...
	if err != nil {
		return newDate, ConcatenateErrorStrings(enums.XYZ_COMMONS_ADD_TIMEZONE_IN_TIME_ERROR_MESSAGE, err.Error())
	}
...
func ValidateEan(ean string) (isValid bool, typeEan string) {
	...
	if verifyingDigit == digit {
		if lengthIs13 {
			return true, enums.XYZ_COMMONS_EAN_TYPE_13
		}

		return true, enums.XYZ_COMMONS_EAN_TYPE_8
	}
...
documentType: is the type of the document. Possible values are in enums XYZ_COMMONS_DOCUMENT_TYPE_*

return: formatted document according to its type
*/
func FormatDocumentByType(document, documentType string) string {
	switch documentType {
	case enums.XYZ_COMMONS_DOCUMENT_TYPE_CNPJ:
		if len(document) == 14 {
